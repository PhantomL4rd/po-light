...
自然光の性質は時間帯と天候によって大きく異なる。

■ 朝（晴れ）: 低い角度の淡い暖色光。影が長く出やすい。
  GPoseのライトは補助程度（キーRGB40〜60）に抑える。
  色温度は暖色寄り（R>G>B）。キャラクターライティング60〜80推奨。

■ 朝（曇り）: 柔らかい拡散光で影が少ない。GPoseで立体感を補う余地がある。
  キーRGB50〜65。色温度はニュートラル〜やや暖色。

■ 昼（晴れ）: 強い指向性の自然光が既にキーライトの役割を果たす。
  GPoseのライト1は補助程度（RGB40〜55）に抑え、フィルで影を和らげることを優先する。
  色温度はニュートラル〜暖色。

■ 昼（曇り）: 拡散光で影が柔らかいため、GPoseのライトで立体感を補う余地がある。
  ライト1をやや強め（RGB55〜75）に設定し、陰影を意図的につくると映える。
  色温度はニュートラル〜やや寒色。

■ 夕方（晴れ）: 強い暖色光。赤みが強いため、ライト1も暖色寄り（R>>G>B）に揃えると馴染む。
  キャラクターライティング50〜70推奨。キーRGB45〜65。

■ 夕方（曇り）: 暖色がやや抑えられた柔らかい光。
  キーRGB50〜70。色温度はやや暖色寄り。

■ 夜（屋外）: 自然光がほぼなく暗い環境。GPoseのライトがメインの光源になる。
  キーRGB70〜100、明るさのマニュアル調整150〜200。
  月光を意識する場合は寒色寄り（B>G>R）にする。
  街灯・暖色環境なら暖色寄り（R>G>B）で環境に馴染ませる。

■ 雨（全時間帯共通）: 非常に拡散した寒色の光環境。全体が青白くなりやすい。
  ライト1に暖色を加えて肌の血色感を補う（R>G=B）。
  バックライトで輪郭を際立たせると雨の雰囲気が引き立つ。

■ 逆光（屋外共通）: 自然光が後ろから当たり正面が暗くなる。
  キャラクターライティングを高め（60〜100）に設定し、ライト1で正面の顔を補う。
  逆光＋夜・夕方の組み合わせは特に暗くなりやすい。明るさのマニュアル調整は120〜160を下限に。
  バックライトは不要または最小限に。
